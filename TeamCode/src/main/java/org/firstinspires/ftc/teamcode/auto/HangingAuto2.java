...
@Autonomous(name="Hang2", group = "Auto")
public final class HangingAuto2 extends LinearOpMode {
    @Override
...
//                        new SleepAction(1),
                        ...
                        new ParallelAction(
                                ...
                                drive.actionBuilder(new Pose2d(35,-60,Math.toRadians(-90)))
                                        ...
                                        .strafeTo(new Vector2d(9, -32.5), new TranslationalVelConstraint(30))
...
//                        new SleepAction(0.5),
                        ...
                        new ParallelAction(
                                ...
                                drive.actionBuilder(new Pose2d(32,-60,Math.toRadians(-90)))
                                        ...
                                        .splineToLinearHeading(new Pose2d(8, -30, -pi/2), pi/2)
                                        .strafeTo(new Vector2d(8, -32.5), new TranslationalVelConstraint(30))
                                        .build()
                        ),
//                        new SleepAction(0.3),
                        // hang specimen 3
...
//                        new SleepAction(0.5),
                        ...
                        new ParallelAction(
                                ...
                                drive.actionBuilder(new Pose2d(32,-60,Math.toRadians(-90)))
                                        ...
                                        .strafeTo(new Vector2d(6, -32.5), new TranslationalVelConstraint(30))
