...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.835691870516372;
        public double trackWidthTicks = 12.557798088225788;

        // feedforward parameters (in tick units)
        public double kS = 1.0391839703869876;
        public double kV = 0.18137189572075535;
